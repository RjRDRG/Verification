...
public class MainPanel extends JFrame {
    ...
    public MainPanel(IContract contract, IContract priorContract, InitPanel initPanel) {
        ...
        for (InitPanel.MethodBuilder m : initPanel.methodBuilders) {
    ...
    class MethodBuilder {
        ...
        public MethodBuilder(InitPanel.MethodBuilder imb) {
